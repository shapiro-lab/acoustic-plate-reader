...
experimental_filename = 'Oncotripsy\Exp_DJ_500kHz_700kPa_PD_SparseA.xlsx';
skipwells = [];
...
for i = 1:24
    ...
    if w.exposure_duration > 0 && w.peak_to_peak > 0 && w.freq > 0 && ~any(ismember(skipwells, i))
