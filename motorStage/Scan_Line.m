...
step_ds    = 0.0002 / params.Stages.step_distance; % Motor steps between each scan
dim1_width = 0.05 / params.Stages.step_distance; 
...
for s1 = 1:step_tot
            ...
            pause(1); % Wait for signal to level out
