...
params.Freq_Vol.frequencies = 4.94E+05; 
params.Freq_Vol.voltages = (5:5:50) .* 10^(params.Amplifier.GainDB/-20);
...
params.SG.Waveform.frequency = 4.94e5;
params.SG.Waveform.voltage = min(params.Freq_Vol.voltages);

params.SG.Waveform.cycles = 50;
params.SG.Waveform.period = 0.001;
