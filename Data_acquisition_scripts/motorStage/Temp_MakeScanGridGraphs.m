...
exclude = {...
        'S:\Ultrasound Data\Mittelstein\results\2017-07-05\delete\results_Scan_Grid_SG_2017-07-05_20-03.mat', ...
        'S:\Ultrasound Data\Mittelstein\results\2017-07-05\delete\results_Scan_Grid_SG_2017-07-05_20-01.mat', ...
        };
...
for i = 1:numel(files);
   ...
   try
    ...
    disp(' - Success!');    
       ...
       if staticdim == 0;
           throw('Could not find static dim');
       end
       ...
       elseif isfield(params.Scan, 'FFT_peak');
           ...
           disp('Cannot find objective function, continue?')
           obj = zeros(numel(params.Scan.Location(1,:)),1);
           pause
       end
