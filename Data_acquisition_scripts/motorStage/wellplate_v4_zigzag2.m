...
for i=indexes
    ...
    while toc(h_tic) < w.exposure_duration
        ...
        elseif zigzag == 1
            zigzag = 2;
            if ~NoStage_Mode; params = sub_Stage_Move_To(params, w.coor + params.Stages.Origin + zigzap_disp); end
        else
            zigzag = 0;
            if ~NoStage_Mode; params = sub_Stage_Move_To(params, w.coor + params.Stages.Origin + 2 * zigzap_disp); end
        end
