...
%will be 1 if stage does not initialize, used in Data Acquistion GUI
params.stage_intialize_error = 0;
% Connect to motors
try
    if strcmpi(stageType,'Small')
    ...
    disp('- Connected to Velmex Stage');
        ...
        params.stage_intialize_error = 1;
        h=errordlg('Could not connect to motor stage','Error');
