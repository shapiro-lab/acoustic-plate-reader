...
Process(nproc).Parameters = {'srcbuffer','receive',...
        ...
        'srcframenum',-1,... 
        'dstbuffer','none'};
EF(n_ext_funct).Function = vsv.seq.function.ExFunctionDef('xDisplay', @xDisplay);
nproc = nproc+1;
n_ext_funct = n_ext_funct + 1 ;                     
...
Process(nproc).Parameters = {'srcbuffer','none','dstbuffer','none'};
EF(n_ext_funct).Function = vsv.seq.function.ExFunctionDef('updateScanParams', @updateScanParams);
nproc = nproc+1;
n_ext_funct = n_ext_funct + 1 ;                     
