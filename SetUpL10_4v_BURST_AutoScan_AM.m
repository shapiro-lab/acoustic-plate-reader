...
% figure; imagesc(20*log10(RData)); colormap hot; colorbar
...
P.pathName = [pwd '\Data\'];
P.prevDataPath = [];
P.saveDirName = '_A2CNissle_OD1e-%d_%dap_%s_%.1fMHz_%.1fcycles_%.1fV_SyncBurst\';
P.saveDirVars = {'P.zLineIdx+5','P.numTx','Trans.name(1:3)','P.twFreq','P.numHalfCycles/2','TPC(2).hv'};
