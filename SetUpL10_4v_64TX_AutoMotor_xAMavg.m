...
num_x_steps = 360; % Modify to change the number of x steps
...
num_z_steps = 30; % Modify to change the number of z steps; never to exceed 30
...
P.xLines = 360; % number of scanned lines in the x-direction (160 for one row of plates; 360 for two rows of plates)
P.zLines = 30; % number of scanned lines in the z-direction (25 for five columns of plates; 30 for six columns)
P.xDist = 0.5; % distance (in mm) to move in each x step
P.zDist = 0.3*(P.numRays-1); % distance (in mm) to move in each z step
